...
export default function SlidePrev() {
  ...
  return (
    <button
      className="absolute top-1/2 md:left-32 left-4 transform -translate-y-1/2 rounded-full w-16 h-16 bg-white shadow-[20px_20px_43px_0px_rgba(20,20,43,0.06)] flex justify-center items-center z-50"
